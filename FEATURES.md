...
| `decodeTransactionCalldata` | Decode transaction input data using Arbitrum contract ABIs. Automatically detects the target contract from transaction hash. | `transactionHash`: Transaction hash to decode (automatically detects contract address from transaction)                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| Tool                  | Description                                                                  | Parameters                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| --------------------- | ---------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `simulateTransaction` | Simulate Arbitrum transaction with state override and comprehensive analysis | `from`: From address, `to`: To address, `data`: Optional transaction calldata (hex string), `value`: Optional value in wei (hex string), `gas`: Optional gas limit (hex string), `gasPrice`: Optional gas price (hex string), `maxFeePerGas`: Optional max fee per gas for EIP-1559 (hex string), `maxPriorityFeePerGas`: Optional max priority fee per gas for EIP-1559 (hex string), `blockIdentifier`: Optional block identifier (number, hash, or tag like 'latest'), `stateOverride`: Optional state overrides for simulation (address -> override) |
